...
public static class ORiN3ValueFactory
{
    public static ORiN3Value Create(bool data)
    {
        ...
        {
            Type = (int)ORiN3ValueType.ORiN3Bool,
    ...
    public static ORiN3Value Create(bool[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3BoolArray,
            BoolArray = array,
        };
    }
    ...
    public static ORiN3Value Create(bool? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableBool,
    ...
    public static ORiN3Value Create(bool?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableBoolArray,
    ...
    public static ORiN3Value Create(byte data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt8,
    ...
    public static ORiN3Value Create(byte[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt8Array,
            UInt8Array = array,
        };
    }
    ...
    public static ORiN3Value Create(byte? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt8,
    ...
    public static ORiN3Value Create(byte?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt8Array,
    ...
    public static ORiN3Value Create(ushort data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt16,
    ...
    public static ORiN3Value Create(ushort[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt16Array,
            UInt16Array = array,
        };
    }
    ...
    public static ORiN3Value Create(ushort? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt16,
    ...
    public static ORiN3Value Create(ushort?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt16Array,
    ...
    public static ORiN3Value Create(uint data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt32,
    ...
    public static ORiN3Value Create(uint[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt32Array,
            UInt32Array = array,
        };
    }
    ...
    public static ORiN3Value Create(uint? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt32,
    ...
    public static ORiN3Value Create(uint?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt32Array,
    ...
    public static ORiN3Value Create(ulong data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt64,
    ...
    public static ORiN3Value Create(ulong[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3UInt64Array,
            UInt64Array = array,
        };
    }
    ...
    public static ORiN3Value Create(ulong? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt64,
    ...
    public static ORiN3Value Create(ulong?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableUInt64Array,
    ...
    public static ORiN3Value Create(sbyte data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int8,
    ...
    public static ORiN3Value Create(sbyte[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int8Array,
            Int8Array = array,
        };
    }
    ...
    public static ORiN3Value Create(sbyte? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt8,
    ...
    public static ORiN3Value Create(sbyte?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt8Array,
    ...
    public static ORiN3Value Create(short data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int16,
    ...
    public static ORiN3Value Create(short[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int16Array,
            Int16Array = array,
        };
    }
    ...
    public static ORiN3Value Create(short? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt16,
    ...
    public static ORiN3Value Create(short?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt16Array,
    ...
    public static ORiN3Value Create(int data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int32,
    ...
    public static ORiN3Value Create(int[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int32Array,
            Int32Array = array,
        };
    }
    ...
    public static ORiN3Value Create(int? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt32,
    ...
    public static ORiN3Value Create(int?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt32Array,
    ...
    public static ORiN3Value Create(long data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int64,
    ...
    public static ORiN3Value Create(long[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Int64Array,
            Int64Array = array,
        };
    }
    ...
    public static ORiN3Value Create(long? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt64,
    ...
    public static ORiN3Value Create(long?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableInt64Array,
    ...
    public static ORiN3Value Create(float data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Float,
    ...
    public static ORiN3Value Create(float[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3FloatArray,
            FloatArray = array,
        };
    }
    ...
    public static ORiN3Value Create(float? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableFloat,
    ...
    public static ORiN3Value Create(float?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableFloatArray,
    ...
    public static ORiN3Value Create(double data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Double,
    ...
    public static ORiN3Value Create(double[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3DoubleArray,
            DoubleArray = array,
        };
    }
    ...
    public static ORiN3Value Create(double? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableDouble,
    ...
    public static ORiN3Value Create(double?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableDoubleArray,
    ...
    public static ORiN3Value Create(DateTime data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3DateTime,
    ...
    public static ORiN3Value Create(DateTime[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3DateTimeArray,
            DateTimeArray = array,
        };
    }
    ...
    public static ORiN3Value Create(DateTime? data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableDateTime,
    ...
    public static ORiN3Value Create(DateTime?[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3NullableDateTimeArray,
    ...
    public static ORiN3Value Create(string data)
    {
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3String,
    ...
    public static ORiN3Value Create(string[] data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3StringArray,
            StringArray = array,
        };
    }
    ...
    public static ORiN3Value Create(object data)
    {
        ...
        return new ORiN3Value()
        {
            Type = (int)ORiN3ValueType.ORiN3Object,
            Object = orin3Object,
        };
    }
}
